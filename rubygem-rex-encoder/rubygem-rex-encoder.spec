# Generated from rex-encoder-0.1.4.gem by gem2rpm -*- rpm-spec -*-
%global gem_name rex-encoder
...
License: BSD
URL: https://github.com/rapid7/rex-encoder
...
a version of a payload that is free of bad characters as defined by the
exploit. .
...
%{gem_instdir}/bin
%{gem_libdir}
%exclude %{gem_instdir}/rex-encoder.gemspec
%exclude %{gem_cache}
%{gem_spec}
