...
Name: john
Version: 1.9.0
%global charsets_version 20130529
Release: owl1
License: GPL
Group: Applications/System
URL: https://www.openwall.com/john/
Source0: john-%version.tar.xz
...
%global cflags -c %optflags -Wall -DJOHN_SYSTEMWIDE=1
...
%endif
install -m 644 -p run/{john.conf,password.lst,*.chr} \
...
- Dropped the smallest bitmap size (4-bit index, which was normally unused
anyway) and introduced a new largest one (30-bit index).
...
- Clarified external mode's C-like language and its drawbacks in doc/EXTERNAL.
...
* Thu Mar 05 2015 Solar Designer <solar-at-owl.openwall.com> 1.8.0.4-owl1
