# Generated from rex-core-0.1.13.gem by gem2rpm -*- rpm-spec -*-
%global gem_name rex-core
...
Rex provides a variety of classes useful for security testing and exploit
development.
...
%{gem_libdir}
%exclude %{gem_instdir}/rex-core.gemspec
%exclude %{gem_cache}
%{gem_spec}
