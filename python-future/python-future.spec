...
Source0:        https://github.com/PythonCharmers/python-future/archive/refs/tags/v%{version}/%{name}-%{version}.tar.gz
BuildArch:      noarch
...
%py_provides   python3-future

Obsoletes: python2-future < 0:%{version}-%{release}
Obsoletes: future-python2 < 0:%{version}-%{release}
Obsoletes: python34-future < 0:%{version}-%{release}

%description -n python%{python3_pkgversion}-future
%{_description}
...
%files -n python%{python3_pkgversion}-future
%license LICENSE.txt
%doc README.rst
%{_bindir}/futurize-3
