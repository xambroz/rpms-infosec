...
%{__install} -m 755 unrar %{buildroot}%{_bindir}/unrar
%{__mkdir_p} %{buildroot}%{_libdir}
%{__install} -m 755 default.sfx %{buildroot}%{_libdir}
%{__mkdir_p} %{buildroot}/etc
%{__install} -m 644 rarfiles.lst %{buildroot}/etc
chmod 644 *
# cd ../oldrar/rar
