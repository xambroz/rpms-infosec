...
Name:     gnulib
Version:  0
Release:  43.%{gitdate}git%{?dist}
Summary:  GNU Portability Library
License:  Public Domain and BSD and GPLv2+ and GPLv3 and GPLv3+ and LGPLv2 and LGPLv2+ and LGPLv3+
URL:      https://www.gnu.org/software/gnulib
Source0:  https://git.savannah.gnu.org/gitweb/?p=gnulib.git;a=snapshot;h=%{githead};sf=tgz;name=gnulib-%{gitdate}-%{githead}.tar.gz#/gnulib-%{gitdate}-%{githead}.tar.gz
Source1:  https://erislabs.net/gitweb/?p=gnulib.git;a=blob_plain;hb=HEAD;f=debian/manpages/check-module.1;name=check-module.1#/check-module.1
Source2:  https://erislabs.net/gitweb/?p=gnulib.git;a=blob_plain;hb=HEAD;f=debian/manpages/gnulib-tool.1;name=gnulib-tool.1#/gnulib-tool.1
...
#-------------------------------------------------------------------------
%changelog
* Fri Feb 18 2022 Michal Ambroz <rebus AT_ seznam.cz> - 0-43.20220213git
- bump to current git snapshot
- fix download of the manpages using spectool -g
- Fix FTBFS
