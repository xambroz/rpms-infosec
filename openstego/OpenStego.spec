...
# ant build removed from upstream
# https://raw.githubusercontent.com/syvaidya/openstego/2f4d84f0e38421809fa8213f0fe1028bfc3fa9ed/build.xml
Source2:        openstego-build.xml
...
%prep
%autosetup -n %{gitname}-%{gitname}-%{version} -p1
...
%changelog
* Fri Feb 10 2023 Michal Ambroz <rebus _AT seznam.cz> - 0.8.6-1
